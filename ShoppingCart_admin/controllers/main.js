...
function addProduct() {
  ...
  var product = new Product(null, name, price, img, desc,screen,backCamera,frontCamera,type);
...
function updateProduct() {
  ...
  // B2: Khởi tạo đối tượng Product
  var product = new Product(id, name, price, img, desc,screen,backCamera,frontCamera,type);
